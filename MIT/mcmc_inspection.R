...
features = read.csv('consignee_features.csv',stringsAsFactors = F)

#Input features



input_X = readline('Enter the indices of the feature columns, separated by comma: ') #3,5,8,9,10,11,12,13,14,15,16
input_S = readline('Enter the index of the inspection status column: ')#17
input_Y = readline('Enter the index of the inspection outcome column: ')#18
